from sentences import get_determiner, get_noun, get_verb, get_preposition, get_prepositional_phrase, get_puncuation, main
import random
import pytest
...
def test_get_puncuation():

    for _ in range(4):
        symbols = [".", "?", "!", "!?"]

        symbol = get_puncuation()
